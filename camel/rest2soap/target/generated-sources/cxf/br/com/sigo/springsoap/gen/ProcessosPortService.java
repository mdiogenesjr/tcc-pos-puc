 ...
 * 2021-06-17T17:03:15.693-03:00
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "ProcessosPortService",
                  wsdlLocation = "file:/C:/projetos/tcc-pos-puc/camel/rest2soap/src/main/resources/wsdl/processos.wsdl",
...
public class ProcessosPortService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/projetos/tcc-pos-puc/camel/rest2soap/src/main/resources/wsdl/processos.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProcessosPortService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/projetos/tcc-pos-puc/camel/rest2soap/src/main/resources/wsdl/processos.wsdl");
        }
        WSDL_LOCATION = url;
    }
