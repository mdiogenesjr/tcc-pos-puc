 ...
 * 2021-03-21T13:51:24.249-03:00
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "ProcessosPortService",
                  wsdlLocation = "file:/C:/projetos/tcc-pos-puc/camel/src/main/resources/wsdl/processos.wsdl",
...
public class ProcessosPortService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/projetos/tcc-pos-puc/camel/src/main/resources/wsdl/processos.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProcessosPortService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/projetos/tcc-pos-puc/camel/src/main/resources/wsdl/processos.wsdl");
        }
        WSDL_LOCATION = url;
    }
